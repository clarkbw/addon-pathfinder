...
exports.ToolbarButton = Class({
  initialize: function(options) {
    ...
    var delegate = {
      onTrack: function (window) {
        ...
        var index = TBB_NS(self).destoryFuncs.push(unloadFunc) - 1;
        listen(window, window, "unload", function() {
          TBB_NS(self).destoryFuncs[index] = null;
        }, false);
  ...
  destroy: function() {
    ...
    TBB_NS(this).destoryFuncs.forEach(function(f) f && f());
    TBB_NS(this).destoryFuncs.length = 0;
